 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "train_app.com", ownerName = "train_app.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyB64g6OmlO-vQrsofta9aLd-DeJB2LefbI";
